    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://avatars.githubusercontent.com/u/121758276?v=4"
              alt="Jubayer"
              width="192"
              height="192"
              quality="95"
      ...
      >
        <span className="font-bold">Hello, I'm Jubayer.</span> I'm a{" "}
      ...
      >
        ...
        <Link
          ...
          href="/Resume of Md Jubayer Hosen - Mern Stack developer (2).pdf"
          download={true}
          target={"_blank"}
        >
          Download RESUME{" "}
